...
//    DropdownTable.showsVerticalScrollIndicator=NO;
    ...
    Animation(self.superview, 0.30f,UIViewAnimationOptionTransitionNone,
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath;
{
  ...
  //  Contentlbl.font=AvenirNextMedium(appDelegate.font);
...
//    cell.contentView.backgroundColor=RGB(248, 218, 218);
  ...
  // [ParentBtn setTitleColor:Singlecolor(clearColor) forState:UIControlStateNormal];
...
-(void)CloseAnimation{
    ...
    Animation(self.superview, 0.10f,UIViewAnimationOptionTransitionNone,
