...
- (void)show
{
	...
	[navItem setRightBarButtonItem:[[[UIBarButtonItem alloc] initWithTitle:@"Sign-in" style:UIBarButtonItemStyleDone target:self action:@selector(loginWithCredentialsFromDialog:)] autorelease]];
